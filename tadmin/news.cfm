...
<li class="nav-item">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
       ...
       <div class="container">
       <a href="news-add.cfm" class="btn btn-primary m-2">Add</a>
        <table class="table">
            <thead>
              <tr>
                <th scope="col">#</th>
            ...
            <cfoutput query="EmpList">
              ...
              <tr>
                <th scope="row">#n_id#</th>
                <td>#n_name#</td>
                <td>#n_content#</td>
                <td><a href="news-update.cfm?nId=#n_id#" class="btn btn-primary">Update</a></td>
                <td><a href="actionPage2.cfm?nId=#n_id#" class="btn btn-danger">Danger</a></td>
              </tr>
              </cfoutput>
            </tbody>
          </table>
